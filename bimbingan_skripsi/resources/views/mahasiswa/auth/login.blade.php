    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color:#d9dbde;"><strong>Mahasiswa Login</strong></div>
                <div class="panel-body" style="background-color:#eaedf1;">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/mahasiswa/login') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <a class="btn btn-link" href="{{ url('/mahasiswa/password/reset') }}">
