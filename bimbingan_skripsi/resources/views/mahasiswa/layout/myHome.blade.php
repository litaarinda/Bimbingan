...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>Welcome</b>Student</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form id="logout-form" action="{{ url('/mahasiswa/logout') }}" method="POST" style="display: none;">
        ...
        <li><a href="/mahasiswa/profil"><i class="fa fa-graduation-cap"></i> <span>Profil</span></a></li>
        <li><a href="/mahasiswa/perkembangan"><i class="fa fa-bar-chart"></i> <span>Perkembangan Skripsi</span></a></li>
        <li><a href="/mahasiswa/riwayatmhs"><i class="fa fa-calendar"></i> <span>Riwayat Bimbingan</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
