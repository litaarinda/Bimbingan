      ...
      <form id="logout-form" action="{{ url('/admin/logout') }}" method="POST" style="display: none;">
        ...
        <li class="treeview"><a href="#"><i class="fa fa-graduation-cap"></i> <span>Mahasiswa</span>
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-th-list"></i>Data Mahasiswa</a></li>
            <li><a href="#"><i class="fa fa-user-plus"></i>Tambah Data</a></li>
          </ul>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-th-list"></i>Data Dosen</a></li>
            <li><a href="#"><i class="fa fa-user-plus"></i>Tambah Data</a></li>
          </ul>
        </li>
      </ul>
